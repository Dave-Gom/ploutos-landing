          ...
          <div className="flex flex-wrap gap-3" id="download">
            ...
            >
              ...
              <span className="flex flex-col text-left leading-tight">
                <span className="text-[11px] font-medium opacity-75 tracking-wide">{t.appStoreLabel}</span>
                <span className="text-base font-bold tracking-tight">{t.appStoreName}</span>
              </span>
            </a>
            ...
            >
              ...
              <span className="flex flex-col text-left leading-tight">
                <span className="text-[11px] font-medium opacity-75 tracking-wide">{t.playStoreLabel}</span>
                <span className="text-base font-bold tracking-tight">{t.playStoreName}</span>
              </span>
            </a>
          </div>

          <div className="mt-9 flex flex-wrap gap-7 text-[13.5px] text-neutral">
            {[t.badgeNoAccount, t.badgeEncryption, t.badgeOffline].map((badge) => (
